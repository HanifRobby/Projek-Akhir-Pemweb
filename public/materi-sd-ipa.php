...
<body>
    ...
    <main>
        ...
        <div class="materi-head-container">
            <img class="materi-img" src="../assets/images/microscope.png" alt="">
        ...
        <div class="materi-board">
            <?php
                ...
                $result = mysqli_query($conn, "SELECT * FROM materi2");
                $resultyutub = mysqli_query($conn, "SELECT * FROM yutubipa");
                $mergearray = array();
                $mergearray2 = array();
