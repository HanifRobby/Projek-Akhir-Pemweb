...
<body>
    ...
    <main>
        <div class="course-board">
            ...
            <div class="soal-card">
                <div class="soal">
                    <h2>1. Ikan bernafas dengan?</h2>
                </div>
                <div class="pilihan">
                    <label class="chosee" for="option1">
                        <input type="radio" id="option1" name="option" value="option1"> Paru-paru
                    </label>
                    <label class="chosee" for="option2">
                        <input type="radio" id="option2" name="option" value="option2"> Insang
                    </label>
                    <label class="chosee" for="option3">
                        <input type="radio" id="option3" name="option" value="option3"> Kulit
                    </label>
                    <label class="chosee" for="option4">
                        <input type="radio" id="option3" name="option" value="option3"> Kloaka
                    </label>
                    </form>
                </div>
            </div>
